# back/connect_db/management/commands/check_task_deadlines.py
...
from connect_db.models import Maintask, Subtask, Dailytask
...
class Command(BaseCommand):
    help = 'Check task deadlines and send notifications'
